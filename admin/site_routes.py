...
def acp_user_detail(uid):
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px">
        ...
        <div class="card">
            ...
            {'<form method="post" style="display:inline;margin-left:8px"><input type="hidden" name="action" value="suspend"><input type="hidden" name="reason" value="Admin action"><button class="btn btn-danger btn-sm" onclick="return confirm(\'Suspend this user?\')">Suspend</button></form>' if not is_susp else ''}
        </div>
    </div>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px">
        ...
        <div class="card">
            ...
            <div style="display:flex;gap:8px;flex-wrap:wrap">
                {'<form method="post" style="display:inline"><input type="hidden" name="action" value="cancel"><button class="btn btn-danger btn-sm" onclick="return confirm(\'Cancel this job?\')">Cancel Job</button></form>' if job.get('status') in ('running','queued') else ''}
